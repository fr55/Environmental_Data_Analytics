...
```{r}
mean_sequ <- mean(hundred_sequence_byfour) # computing the mean and asigning it to an object
mean_sequ # printing the mean
median_sequ <- median(hundred_sequence_byfour) # computing the median and asigning it to an object
