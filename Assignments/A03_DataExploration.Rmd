...
# 1
NTL_LTER_Lake.data.complete <- na.omit(NTL_LTER_Lake.data) #I´m assuming an NA Temperature doesnt give us useful information.
ggplot(NTL_LTER_Lake.data.complete, aes(x = temperature_C)) +
  geom_bar()
# 2
...
# 4
ggplot(NTL_LTER_Lake.data.complete) + #WORKING IN THIS CODE
