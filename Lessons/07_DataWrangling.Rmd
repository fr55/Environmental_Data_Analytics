...
NTL.phys.data.JunethruOctober4 <- filter(NTL.phys.data, daynum %in% c(152:304)) # 152 and 304 are included
...
> ANSWER: Not reprodusable. Not very efficient. You have to look what you want to do. MAybe in an actualization of the raw data the rows change.
...
```{r}
NTL.phys.data.temps <- select(NTL.phys.data, lakename, sampledate:temperature_C) # use comas (and) and colons (through). Doesnt work with & for example
