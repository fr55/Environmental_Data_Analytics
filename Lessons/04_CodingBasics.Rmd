...
vector1[3] # it is getting the third element of vector 1. Called Matrix subsetting

# Matrices ----
matrix1 <- matrix(1:19, nrow = 5, ncol = 4) # numbers go vertically (default)
matrix1
matrix2 <- matrix(1:20, nrow = 5, ncol = 4, byrow = TRUE) # changes the deffault
matrix2
...
matrix1[4, ] # row 4 of matrix 1
matrix1[ , 3] # 
matrix1[c(12, 14)] #
matrix1[c(12:14)] #
matrix1[2:4, 1:3] # matrix subset
...
list1[[2]]
list1[["mynumbers"]] # the same as above
...
dataframe1[1:3] # you call columns 1 to 3. If you want rows put a coma afterwards
dataframe1[c("ID","Passed")] # 
dataframe1$Color # you get the column
...
> ANSWER: It says if you were succesful instaling the package and any warnings.
...
# if else can be used with vectors
recipe5 <- function(x) {
  if(x < 3) {
    x*2
  } 
